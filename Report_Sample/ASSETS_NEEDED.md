...
| File | Status | Notes |
|------|--------|--------|
| `bharatmart-logo.png` | Ready | Cover logo |
| `rgukt_logo.png` | Ready | College logo on title / certificate / declaration |
| `architecture.png` | Generate next | Use prompt in `ARCHITECTURE_PROMPT.md` |
| `homepage.png` | Later | Storefront homepage screenshot |
